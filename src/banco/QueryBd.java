...
//
//Atrav�s dessa classe irei criar metodos para a conex�o
public class QueryBd {
	...
	// Verifica se o administrador informado � valido
	...
	public void addPaciente(String cpf, String nome, String endereco, String email,
		...
		try {
			...
			if (rs.next()) {
				...
				boolean existe = pegaId(cpf); // Pega o id do paciente (ele � serial) entao nao tenho acesso
	...
	public void addMedico(String cpf, String nome, String especialidade, String sexo, MedicoModel medicomodel) {
		...
		try {
			...
			if (rs.next()) {
				...
				boolean existe = pegaIdMedico(cpf); // Pega o id do paciente (ele � serial) entao nao tenho acesso
	...
	public void atualizarConsulta(String procedimento, String data, String horario, int idConsulta,
		...
		try {
			...
			// informado
			boolean Noexiste = verificaConsulta2(data, horario, nomeMedico);
			boolean paciente = pacienteAgendado(data, nomePaciente, horario);

			if (Noexiste && paciente) {
	...
	public void enviarEmail(int idPacientee, String nomePaciente, String data, String horario) {
		...
		try {
			...
			if (rs.next()) {
				...
				String mensagem = "Ol� " + nomePaciente + " Sua consulta foi marcada com sucesso " + " Data: " + data
						+ " Horario: " + horario;
		...
		try {
			...
			if (rs.next()) {
				JOptionPane.showMessageDialog(null,
						"o paciente selecionado ja possui uma consulta marcada, n�o � possivel agendar duas consultas para o mesmo dia",
	...
	public void enviarEmailPaciente(String nome, String email) {
		...
		String mensagem = "Ol� " + nome + " seu cadastro na clinica HospitalNator foi feito com sucesso!!";
	...
	public void pesquisarConsultaDatas(String dataa, AgendaModel agendaTable, JDateChooser calendario) {
		...
		try {
			...
			if (i <= 0) {
				...
				JOptionPane.showMessageDialog(null, "N�o encontramos nenhuma consulta agendada para o dia " + dataa);
